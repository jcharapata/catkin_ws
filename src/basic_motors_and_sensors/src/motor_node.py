...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep 23 13:32:59 2021
...
def listener(): 
    ...
    sub1 = rospy.Subscriber('/wheel_command_left', Float32, set_wheel_command_left) 
 
    #### CODE HERE ####
    sub2 = rospy.Subscriber('/wheel_command_right', Float32, set_wheel_command_right) 
...
def set_wheel_command_right(msg_in):
    wheel_command_right = int(msg_in.data)
