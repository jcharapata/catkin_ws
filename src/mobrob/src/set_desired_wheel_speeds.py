...
# Sam's Initials
stage_settings = np.array( [ [.29, -.4, .4], [2.2, 0.4, 0.6], [2.2, 0.6, 0.4], [2, -0.5, -0.5], [.29, .4, -.4], [3, 0.5, 0.5], [1.5, -0.5, -0.5], [.1, -0.4, 0.4], [1.8, -0.5, -0.5], [1.8, 0.5, 0.5], [.22, 0.4, -0.4], [1.8, 0.5, 0.5] ])
