...
stage_settings = np.array([[2,0,0], [.79,0.3,-0.3], [1.58, 0, 0.3],[1,0.3,0.3], [1.5, -.3, -.3], [.395, .3, -.3], [.7, 0.3, 0.3], [.395, -.3, .3], [.9, .3, .3], [1.3, .3, .12], [2.6, -.3, -.12]])
stage_settings[:,0]*=2
stage_settings[:,1]*=(1/2)
stage_settings[:,2]*=(1/2)
